...
export default function ContactoSection() {
  const { socials } = RESUME_DATA.personal;
  ...
  return (
    <Section id="contacto" title="Contacto">
      <p className={styles.intro}>
        Si deseas colaborar en algún proyecto, tienes preguntas o quieres conversar sobre desarrollo de software y tecnología, no dudes en ponerte en contacto a través de cualquiera de mis canales oficiales:
      </p>
      <div className={styles.links}>
        {socials.map((social) => {
          const isEmail = social.name.toLowerCase() === 'email';
          const emailVal = isEmail ? social.url.replace('mailto:', '') : '';
